...
PETIT_GUIDE_IDENTITY = (
    'Hi, I’m **Petit Guide**, Bon Voyage’s AI travel companion for French destinations '
...
IDENTITY_ANSWERS = {
    ...
    BON_VOYAGE_QUESTION: (
        '_Bon Voyage_ is a fictional AI travel companion created for the '
        '[DataTalks.club](https://datatalks.club)’s LLM Zoomcamp capstone project.'
        'The goal of the project is to showcase an end-to-end RAG application: '
