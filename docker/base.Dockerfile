...
# Create the runtime user and writable application directory before installing.
...
# Dependencies and the embedding model are common to ingestion and query services.
# Keeping them in this image means source-only changes reuse these expensive layers.
